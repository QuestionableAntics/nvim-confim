...
_G.packer_plugins = {
  ...
  ["markdown-preview.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/kean.mattingly@equipmentshare.com/.local/share/nvim/site/pack/packer/opt/markdown-preview.nvim",
